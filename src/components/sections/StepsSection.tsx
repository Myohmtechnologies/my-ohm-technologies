    ...
    <div className="relative bg-gray-50 py-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900">Les étapes clés d'une installation</h2>
          <p className="text-green-700 font-medium">L'énergie solaire à votre portée.</p>
        </div>
