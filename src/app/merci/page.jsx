  ...
  return (
    <><div className="merci-container">
      ...
      <div className="notification">
        ...
        <p>My ohm technologies vous confirme que votre demande a bien été reçue. Un conseiller expert va vous contacter dans les plus brefs délais
        pour discuter de votre projet et répondre à toutes vos questions.</p>
      </div>
      ...
      <div className='merci-info'>
        ...
        <div className="recommendation-map">
          <img src="/images/simulation-google-maps.png" alt="Localisation de l'installation" />
        
        </div>
      </div>
    </div><div className="autoconsommation-section">
        {/* Texte explicatif */}
        <div className="autoconsommation-text">
          <h3>Réduisez votre facture grâce à l'autoconsommation solaire.</h3>
          <p>
            L'autoconsommation représente la part de l'électricité produite par vos panneaux solaires que vous consommez directement.
            Utiliser votre électricité solaire en journée augmente sensiblement la rentabilité de votre projet !
          </p>
        </div>
        ...
        <div className="autoconsommation-graph">
          ...
          <img src="/images/courbe-autoconsomation.png" alt="Courbe de consommation et de production" className="graph-image" />
